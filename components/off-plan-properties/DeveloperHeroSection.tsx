...
type DeveloperHeroSectionProps = {
  title: string;
  description?: string;
  image?: string;
};
...
export default function DeveloperHeroSection({
  title,
  description,
  image = "/assets/developers/featured/emaar-featured.webp",
}: DeveloperHeroSectionProps) {
        ...
        <Container>
          <div className="relative z-20 w-full py-28 md:py-32 lg:py-36">
            <div className="max-w-xl text-center md:text-left">
              ...
              {/* Trust signals */}
              {/* <motion.p
                className="mt-6 text-[11px] tracking-wide text-white/35"
                variants={fadeUp}
                initial="hidden"
                animate={isInView ? "visible" : "hidden"}
                custom={0.3}
              >
                Expert guidance&nbsp;·&nbsp;Fast callbacks&nbsp;·&nbsp;No obligation
              </motion.p> */}
            </div>
          </div>
        </Container>
