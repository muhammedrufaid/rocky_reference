          ...
          <div className="flex h-16 md:h-20 min-w-0 items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <a
                ...
                className="hidden sm:flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-[#25D366] rounded-lg hover:bg-[#1EBE5D] transition-colors"
              >
