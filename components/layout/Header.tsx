...
const Header: React.FC<HeaderProps> = ({ forceSolid = false, hideOnScroll = false }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar panel */}
      <aside
        className={`lg:hidden fixed top-0 right-0 bottom-0 z-50 w-[min(320px,85vw)] flex flex-col bg-white shadow-2xl transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${
